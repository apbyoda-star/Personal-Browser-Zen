...
zen-theme-marketplace-header = Vector Mods
...
pane-zen-marketplace-title = Vector Mods
...
zen-urlbar-title = Vector URL Bar
...
zenCKSOption-group-zen-other = Other Vector Features
